...
public class TestBinaryDatatype {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Test 3: Test .length property (variable chain function)
            System.out.println("Test 3: Testing .length property");
            String script3 = """
            ...
            System.out.println();
            System.out.println("Note: Variable chain functions (toString, get, set, slice, concat, toBase64)");
