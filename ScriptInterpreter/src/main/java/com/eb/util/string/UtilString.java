...
import static com.eb.util.UtilConvert.charToHex;
import static com.eb.util.UtilConvert.hexToChar;
...
public class UtilString extends UtilUnicode {
    ...
    public static boolean isChar(ECharMappings pCharType, char pChar) {
        switch (pCharType) {
            ...
            case NUMERIC_COMMA_CHAR:
                return (CHAR_mapping[pChar] & (MASK_NUMERIC_CHAR + MASK_NUMERIC_COMMA_CHAR)) > 0;
            case NAME_CHAR:
                return (CHAR_mapping[pChar] & MASK_NAME_CHAR) == MASK_NAME_CHAR;
            case COMPLEX_NAME_CHAR:
            ...
            case ALPHA_UPPER_CHAR:
                return (CHAR_mapping[pChar] & MASK_ALPHA_UPPER_CHAR) == MASK_ALPHA_UPPER_CHAR;
            case CONST_CHAR:
                return (CHAR_mapping[pChar] & MASK_CONST_CHAR) == MASK_CONST_CHAR;
            case CONST_UPPER_CHAR:
                return (CHAR_mapping[pChar] & (MASK_CONST_CHAR + MASK_ALPHA_UPPER_CHAR)) == MASK_CONST_CHAR + MASK_ALPHA_UPPER_CHAR;
        }
        return false;
    }
    ...
    public static char[] getCharArray(ECharMappings pCharType) {
        switch (pCharType) {
            case WHITESPACES_CHAR:
                return WHITESPACES_CHAR.toCharArray();
            case SPECIAL_CHAR:
                return SPECIAL_CHAR.toCharArray();
            case ALPHA_CHAR:
                return ALPHA_CHAR.toCharArray();
            case NUMERIC_CHAR:
                return NUMERIC_CHAR.toCharArray();
            case NAME_CHAR:
                return NAME_CHAR.toCharArray();
            case COMPLEX_NAME_CHAR:
                return COMPLEX_NAME_CHAR.toCharArray();
            case DIV_CHAR:
                return DIV_CHAR.toCharArray();
            case OPERAND_CHAR:
                return OPERAND_CHAR.toCharArray();
            case ALPHA_UPPER_CHAR:
                return ALPHA_UPPER_CHAR.toCharArray();
            case CONST_CHAR:
                return CONST_CHAR.toCharArray();
        }
        return new char[0];
    }
