...
// Statement form (e.g., "#json.get(j, \"path\");")
    ...
    /**
     * Enum for JavaFX input item types with default styles
     */
    enum InputItemType {
        // Text Input Controls
    ...
    static class DisplayMetadata {
        InputItemType itemType;   // Input item type enum
        String type;              // JavaFX input item type string (for compatibility)
