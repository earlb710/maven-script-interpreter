...
public class InterpreterScreen {
     ...
     */
    private void validateDisplayProperties(Map<String, Object> displayDef, String screenName) {
        // Define valid display properties (including snake_case and lowercase variants)
     ...
     */
    private void validateAreaItemProperties(Map<String, Object> itemDef, String screenName) {
        // Define valid item properties (including snake_case and lowercase variants)
        java.util.Set<String> validProps = new java.util.HashSet<>(java.util.Arrays.asList(
    ...
    private void processVariableList(List varsList, String setName, String screenName, int line,
        ...
        for (Object varObj : varsList) {
            if (varObj instanceof Map) {
                ...
                var.setInitValue(value);  // Set both value and original value to keep item clean
