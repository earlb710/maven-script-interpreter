...
//        }, "demo-thread");
    ...
    private void initUI(BorderPane root) {
        ...
        // Create project tree view on the left side
        ...
        splitPane.setDividerPositions(0.20); // 20% for tree, 80% for main content
        
        // Set minimum width for project tree (12% of window)
