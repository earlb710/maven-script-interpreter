...
public class FtpConfigDialog extends Stage {
    ...
    public FtpConfigDialog() {
        ...
        nameColumn.setCellFactory(column -> new FocusCommitTextFieldCell<>(FtpConfigEntry::setVarName));
        ...
        urlColumn.setCellFactory(column -> new FocusCommitTextFieldCell<>(FtpConfigEntry::setUrl));
